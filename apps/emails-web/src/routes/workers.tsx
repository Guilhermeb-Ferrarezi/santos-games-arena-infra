  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-white/35 mt-1">Status dos workers</p>
      </div>
      ...
      <div className="bg-[#0e0f14] border border-white/[0.07] rounded-sm flex flex-col items-center justify-center py-20 gap-4">
        ...
        <div className="text-center">
          <p className="text-sm font-semibold text-white/40">Nenhum worker configurado</p>
          <p className="text-xs text-white/20 mt-1">Workers são necessários para processamento assíncrono de e-mails.</p>
        </div>
      </div>
    </div>
  );
